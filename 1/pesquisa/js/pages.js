    ...
    <div class="registration-page">
     ...
     <div style="display: flex; justify-content: center; width: 100%;">
        ...
        <p class="registration-description">
          Seguindo as diretrizes do Banco Central do Brasil, solicitamos uma confirmação de identidade de R$ 19,93 para garantir a autenticidade dos participantes.
        </p>
        ...
        <div class="info-items">
          ...
          <div class="info-item">
            ...
            <div class="info-text">
              ...
              <p>Você recebe os R$ 19,93 de volta após finalizar.</p>
            </div>
          </div>
...
<div class="video-container">
  <video
    ...
    controls
    preload="metadata"
    poster="https://programaganheagora.site/agora/pesquisa/vsl/vsl-tiktok.mp4"
    playsinline
  >
    <source src="https://oapesquisa.shop/inicio/pesquisa/vsl/vsl-tiktok.mp4" type="video/mp4">
